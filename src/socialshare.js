...
render(){
    return(
        <span className="sharetext">Share this Quiz: 
          <a href="https://www.facebook.com/dialog/feed?app_id=184683071273&link=https%3A%2F%2Fwww.accountingtoday.com%2Fhow-does-your-firm-rank-quiz
          " target="_blank" rel="noopener noreferrer" onClick={() => {this.props.reactClickEvent("Social - Facebook")}}>
